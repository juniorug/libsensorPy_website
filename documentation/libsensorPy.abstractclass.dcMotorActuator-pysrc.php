...
<head>
  <title>libsensorPy.abstractclass.dcMotorActuator</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.abstractclass.dcMotorActuator-pysrc.php"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.abstractclass.dcMotorActuator-module.php">Module libsensorPy.abstractclass.dcMotorActuator</a></h1>
<pre class="py-src">
...
<a name="DCMotorActuator"></a><div id="DCMotorActuator-def"><a name="L8"></a><tt class="py-lineno"> 8</tt>  <tt class="py-line"> </tt>
<a name="L9"></a><tt class="py-lineno"> 9</tt> <a class="py-toggle" href="#" id="DCMotorActuator-toggle" onclick="return toggle('DCMotorActuator');">-</a><tt class="py-line"><tt class="py-keyword">class</tt> <a class="py-def-name" href="libsensorPy.abstractclass.dcMotorActuator.DCMotorActuator-class.php">DCMotorActuator</a><tt class="py-op">(</tt><tt class="py-base-class">MotorActuator</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="DCMotorActuator-collapsed" style="display:none;" pad="++" indent="++++"></div><div id="DCMotorActuator-expanded"><a name="L10"></a><tt class="py-lineno">10</tt>  <tt class="py-line">    <tt class="py-docstring">'''</tt> </tt>
...
<a name="DCMotorActuator.__init__"></a><div id="DCMotorActuator.__init__-def"><a name="L15"></a><tt class="py-lineno">15</tt> <a class="py-toggle" href="#" id="DCMotorActuator.__init__-toggle" onclick="return toggle('DCMotorActuator.__init__');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.dcMotorActuator.DCMotorActuator-class.php#__init__">__init__</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="DCMotorActuator.__init__-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="DCMotorActuator.__init__-expanded"><a name="L16"></a><tt class="py-lineno">16</tt>  <tt class="py-line">        <tt class="py-docstring">'''</tt> </tt>
...
<a name="DCMotorActuator.setStepSequence"></a><div id="DCMotorActuator.setStepSequence-def"><a name="L22"></a><tt class="py-lineno">22</tt> <a class="py-toggle" href="#" id="DCMotorActuator.setStepSequence-toggle" onclick="return toggle('DCMotorActuator.setStepSequence');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.dcMotorActuator.DCMotorActuator-class.php#setStepSequence">setStepSequence</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">,</tt> <tt class="py-param">stepSequence</tt> <tt class="py-op">=</tt> <tt class="py-number">8</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="DCMotorActuator.setStepSequence-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="DCMotorActuator.setStepSequence-expanded"><a name="L23"></a><tt class="py-lineno">23</tt>  <tt class="py-line">        <tt class="py-docstring">"""</tt> </tt>
...
<a name="L29"></a><tt class="py-lineno">29</tt>  <tt class="py-line">    <tt class="py-decorator">@</tt><tt class="py-decorator">abc</tt><tt class="py-op">.</tt><tt class="py-name">abstractmethod</tt> </tt>
<a name="DCMotorActuator.setDirection"></a><div id="DCMotorActuator.setDirection-def"><a name="L30"></a><tt class="py-lineno">30</tt> <a class="py-toggle" href="#" id="DCMotorActuator.setDirection-toggle" onclick="return toggle('DCMotorActuator.setDirection');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.dcMotorActuator.DCMotorActuator-class.php#setDirection">setDirection</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">,</tt><tt class="py-param">direction</tt> <tt class="py-op">=</tt> <tt class="py-number">1</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="DCMotorActuator.setDirection-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="DCMotorActuator.setDirection-expanded"><a name="L31"></a><tt class="py-lineno">31</tt>  <tt class="py-line">        <tt class="py-docstring">""" Sets the rotation's direction </tt> </tt>
<a name="L32"></a><tt class="py-lineno">32</tt>  <tt class="py-line"><tt class="py-docstring">        @param direction: 1 = clockwise, 2 anti-clockwise </tt> </tt>
<a name="L33"></a><tt class="py-lineno">33</tt>  <tt class="py-line"><tt class="py-docstring">        @type direction: int8</tt> </tt>
