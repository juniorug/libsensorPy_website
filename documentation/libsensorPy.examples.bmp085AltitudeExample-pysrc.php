...
<head>
  <title>libsensorPy.examples.bmp085AltitudeExample</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.examples.bmp085AltitudeExample-pysrc.php"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.examples.bmp085AltitudeExample-module.php">Module libsensorPy.examples.bmp085AltitudeExample</a></h1>
<pre class="py-src">
...
<a name="L7"></a><tt class="py-lineno"> 7</tt>  <tt class="py-line"><tt class="py-keyword">from</tt> <tt id="link-0" class="py-name" targets="Package libsensorPy.concretefactory=libsensorPy.concretefactory-module.php"><a title="libsensorPy.concretefactory" class="py-name" href="#" onclick="return doclink('link-0', 'concretefactory', 'link-0');">concretefactory</a></tt><tt class="py-op">.</tt><tt id="link-1" class="py-name" targets="Module libsensorPy.concretefactory.altitudeSensorFactory=libsensorPy.concretefactory.altitudeSensorFactory-module.php"><a title="libsensorPy.concretefactory.altitudeSensorFactory" class="py-name" href="#" onclick="return doclink('link-1', 'altitudeSensorFactory', 'link-1');">altitudeSensorFactory</a></tt> <tt class="py-keyword">import</tt> <tt id="link-2" class="py-name" targets="Class libsensorPy.concretefactory.altitudeSensorFactory.AltitudeSensorFactory=libsensorPy.concretefactory.altitudeSensorFactory.AltitudeSensorFactory-class.php"><a title="libsensorPy.concretefactory.altitudeSensorFactory.AltitudeSensorFactory" class="py-name" href="#" onclick="return doclink('link-2', 'AltitudeSensorFactory', 'link-2');">AltitudeSensorFactory</a></tt> </tt>
...
libsensorPy.extension.extendedUltrasonicSensorFactory.ExtendedUltrasonicSensorFactory.createSensor" class="py-name" href="#" onclick="return doclink('link-4', 'createSensor', 'link-4');">createSensor</a></tt><tt class="py-op">(</tt><tt class="py-string">"BMP085Altitude"</tt><tt class="py-op">)</tt> </tt>
<a name="L12"></a><tt class="py-lineno">12</tt>  <tt class="py-line">    <tt class="py-keyword">print</tt> <tt class="py-op">(</tt><tt class="py-string">"Altitude:    %.2f"</tt> <tt class="py-op">%</tt> <tt class="py-name">bmp</tt><tt class="py-op">.</tt><tt id="link-5" class="py-name" targets="Method libsensorPy.abstractclass.altitudeSensor.AltitudeSensor.getAltitude()=libsensorPy.abstractclass.altitudeSensor.AltitudeSensor-class.php#getAltitude,Method libsensorPy.compositesensor.bmp085Composite.BMP085Composite.getAltitude()=libsensorPy.compositesensor.bmp085Composite.BMP085Composite-class.php#getAltitude,Method libsensorPy.concretesensor.bmp085Altitude.BMP085Altitude.getAltitude()=libsensorPy.concretesensor.bmp085Altitude.BMP085Altitude-class.php#getAltitude"><a title="libsensorPy.abstractclass.altitudeSensor.AltitudeSensor.getAltitude
libsensorPy.compositesensor.bmp085Composite.BMP085Composite.getAltitude
libsensorPy.concretesensor.bmp085Altitude.BMP085Altitude.getAltitude" class="py-name" href="#" onclick="return doclink('link-5', 'getAltitude', 'link-5');">getAltitude</a></tt><tt class="py-op">(</tt><tt class="py-op">)</tt><tt class="py-op">)</tt> </tt>
