      ...
      <ul>
        <li class="right" style="margin-right: 10px">
          <a href="http://www.raspberrypi.org/" title="Raspberry Pi">
             <img src="<?=$siteUrl?>/img/raspberrypiTrademarksNoBack.png" alt="LibsensorPy Project">
	  </a>
        </li>
        <li><a href="<?=$siteUrl?>">
	     <img src="<?=$siteUrl?>/img/libsensorPy_NoMerchandSmall.png" alt="LibsensorPy">
	    </a>
        </li> 
      </ul>
    </div>   
...
<h1>Welcome to libsensorPy!<a class="headerlink" href="<?=$siteUrl?>#welcome-to-libsensorpy-s-documentation" title="Permalink to this headline">¶</a></h1>
...
<h1>News / Announcements<a class="headerlink" href="<?=$siteUrl?>#indices-and-tables" title="Permalink to this headline">¶</a></h1>
<b>2015-04-23</b>
...
<h1>Project Status<a class="headerlink" href="<?=$siteUrl?>#indices-and-tables" title="Permalink to this headline">¶</a></h1>
...
<h1>Features<a class="headerlink" href="<?=$siteUrl?>#indices-and-tables" title="Permalink to this headline">¶</a></h1>
<ul>
...
<h1>Getting Started<a class="headerlink" href="<?=$siteUrl?>#indices-and-tables" title="Permalink to this headline">¶</a></h1>
...
<h1>Examples<a class="headerlink" href="<?=$siteUrl?>#indices-and-tables" title="Permalink to this headline">¶</a></h1>
...
<h1>Indices and tables<a class="headerlink" href="<?=$siteUrl?>#indices-and-tables" title="Permalink to this headline">¶</a></h1>
<ul class="simple">
...
<li><a class="reference internal" href="search"><em>Search Page</em></a></li>
  ...
  <h3><a href="<?=$siteUrl?>">LibsensorPy</a></h3>
  <ul>
	<li><a class="reference internal" href="<?=$siteUrl?>">Welcome</a><ul></ul></li>
	<li><a class="reference internal" href="<?=$siteUrl?>#news-announcements">News / Announcements</a><ul></ul></li>
	<li><a class="reference internal" href="<?=$siteUrl?>#project-status">Project Status</a><ul></ul></li>
	<li><a class="reference internal" href="<?=$siteUrl?>#features">Features</a><ul></ul></li>
	<li><a class="reference internal" href="<?=$siteUrl?>#getting-started">Getting Started</a><ul></ul></li>
	<li><a class="reference internal" href="<?=$siteUrl?>#examples">Examples</a><ul></ul></li>
	<li><a class="reference internal" href="<?=$siteUrl?>#indices-and-tables">Indices and tables</a></li>
  </ul>
  <ul>
