...
<head>
  <title>libsensorPy.examples.lsm303dAccelerometerExample</title>
  ...
  <tr valign="top">
    <td width="100%">
      <span class="breadcrumbs">
        ...
        Module&nbsp;lsm303dAccelerometerExample
      </span>
    </td>
    <td>
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.examples.lsm303dAccelerometerExample-pysrc.php"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.examples.lsm303dAccelerometerExample-module.php">Module libsensorPy.examples.lsm303dAccelerometerExample</a></h1>
<pre class="py-src">
...
libsensorPy.extension.extendedUltrasonicSensorFactory.ExtendedUltrasonicSensorFactory.createSensor" class="py-name" href="#" onclick="return doclink('link-4', 'createSensor', 'link-4');">createSensor</a></tt><tt class="py-op">(</tt><tt class="py-string">"LSM303DAccelerometer"</tt><tt class="py-op">)</tt> </tt>
<a name="L11"></a><tt class="py-lineno">11</tt>  <tt class="py-line">    <tt class="py-name">axes</tt> <tt class="py-op">=</tt> <tt class="py-name">lsm303d</tt><tt class="py-op">.</tt><tt id="link-5" class="py-name" targets="Method libsensorPy.abstractclass.accelerometerSensor.AccelerometerSensor.getAxes()=libsensorPy.abstractclass.accelerometerSensor.AccelerometerSensor-class.php#getAxes,Method libsensorPy.compositesensor.lsm303dComposite.LSM303DComposite.getAxes()=libsensorPy.compositesensor.lsm303dComposite.LSM303DComposite-class.php#getAxes,Method libsensorPy.concretesensor.adxl345.ADXL345.getAxes()=libsensorPy.concretesensor.adxl345.ADXL345-class.php#getAxes,Method libsensorPy.concretesensor.lsm303dAccelerometer.LSM303DAccelerometer.getAxes()=libsensorPy.concretesensor.lsm303dAccelerometer.LSM303DAccelerometer-class.php#getAxes"><a title="libsensorPy.abstractclass.accelerometerSensor.AccelerometerSensor.getAxes
libsensorPy.compositesensor.lsm303dComposite.LSM303DComposite.getAxes
libsensorPy.concretesensor.adxl345.ADXL345.getAxes
libsensorPy.concretesensor.lsm303dAccelerometer.LSM303DAccelerometer.getAxes" class="py-name" href="#" onclick="return doclink('link-5', 'getAxes', 'link-5');">getAxes</a></tt><tt class="py-op">(</tt><tt class="py-name">True</tt><tt class="py-op">)</tt> </tt>
