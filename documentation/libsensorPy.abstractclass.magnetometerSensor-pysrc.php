...
<head>
  <title>libsensorPy.abstractclass.magnetometerSensor</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.abstractclass.magnetometerSensor-pysrc.php"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.abstractclass.magnetometerSensor-module.php">Module libsensorPy.abstractclass.magnetometerSensor</a></h1>
<pre class="py-src">
...
<a name="MagnetometerSensor"></a><div id="MagnetometerSensor-def"><a name="L8"></a><tt class="py-lineno"> 8</tt>  <tt class="py-line"> </tt>
<a name="L9"></a><tt class="py-lineno"> 9</tt> <a class="py-toggle" href="#" id="MagnetometerSensor-toggle" onclick="return toggle('MagnetometerSensor');">-</a><tt class="py-line"><tt class="py-keyword">class</tt> <a class="py-def-name" href="libsensorPy.abstractclass.magnetometerSensor.MagnetometerSensor-class.php">MagnetometerSensor</a><tt class="py-op">(</tt><tt class="py-base-class">Sensor</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="MagnetometerSensor-collapsed" style="display:none;" pad="++" indent="++++"></div><div id="MagnetometerSensor-expanded"><a name="L10"></a><tt class="py-lineno">10</tt>  <tt class="py-line"> </tt>
...
<a name="MagnetometerSensor.setup"></a><div id="MagnetometerSensor.setup-def"><a name="L24"></a><tt class="py-lineno">24</tt> <a class="py-toggle" href="#" id="MagnetometerSensor.setup-toggle" onclick="return toggle('MagnetometerSensor.setup');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.magnetometerSensor.MagnetometerSensor-class.php#setup">setup</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="MagnetometerSensor.setup-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="MagnetometerSensor.setup-expanded"><a name="L25"></a><tt class="py-lineno">25</tt>  <tt class="py-line">        <tt class="py-keyword">pass</tt> </tt>
...
<a name="MagnetometerSensor.getMagnetic"></a><div id="MagnetometerSensor.getMagnetic-def"><a name="L28"></a><tt class="py-lineno">28</tt> <a class="py-toggle" href="#" id="MagnetometerSensor.getMagnetic-toggle" onclick="return toggle('MagnetometerSensor.getMagnetic');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.magnetometerSensor.MagnetometerSensor-class.php#getMagnetic">getMagnetic</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="MagnetometerSensor.getMagnetic-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="MagnetometerSensor.getMagnetic-expanded"><a name="L29"></a><tt class="py-lineno">29</tt>  <tt class="py-line">        <tt class="py-docstring">"""Retrieve data from the input source and return an object."""</tt> </tt>
