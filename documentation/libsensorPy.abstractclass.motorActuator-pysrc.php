...
<head>
  <title>libsensorPy.abstractclass.motorActuator</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.abstractclass.motorActuator-pysrc.php"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.abstractclass.motorActuator-module.php">Module libsensorPy.abstractclass.motorActuator</a></h1>
<pre class="py-src">
...
<a name="L7"></a><tt class="py-lineno"> 7</tt>  <tt class="py-line"><tt class="py-keyword">from</tt> <tt id="link-0" class="py-name" targets="Module libsensorPy.abstractclass.actuator=libsensorPy.abstractclass.actuator-module.php"><a title="libsensorPy.abstractclass.actuator" class="py-name" href="#" onclick="return doclink('link-0', 'actuator', 'link-0');">actuator</a></tt> <tt class="py-keyword">import</tt> <tt id="link-1" class="py-name" targets="Class libsensorPy.abstractclass.actuator.Actuator=libsensorPy.abstractclass.actuator.Actuator-class.php"><a title="libsensorPy.abstractclass.actuator.Actuator" class="py-name" href="#" onclick="return doclink('link-1', 'Actuator', 'link-1');">Actuator</a></tt> </tt>
<a name="MotorActuator"></a><div id="MotorActuator-def"><a name="L8"></a><tt class="py-lineno"> 8</tt>  <tt class="py-line"> </tt>
<a name="L9"></a><tt class="py-lineno"> 9</tt> <a class="py-toggle" href="#" id="MotorActuator-toggle" onclick="return toggle('MotorActuator');">-</a><tt class="py-line"><tt class="py-keyword">class</tt> <a class="py-def-name" href="libsensorPy.abstractclass.motorActuator.MotorActuator-class.php">MotorActuator</a><tt class="py-op">(</tt><tt class="py-base-class">Actuator</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="MotorActuator-collapsed" style="display:none;" pad="++" indent="++++"></div><div id="MotorActuator-expanded"><a name="L10"></a><tt class="py-lineno">10</tt>  <tt class="py-line">    <tt class="py-docstring">'''</tt> </tt>
...
<a name="MotorActuator.setup"></a><div id="MotorActuator.setup-def"><a name="L22"></a><tt class="py-lineno">22</tt> <a class="py-toggle" href="#" id="MotorActuator.setup-toggle" onclick="return toggle('MotorActuator.setup');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.motorActuator.MotorActuator-class.php#setup">setup</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="MotorActuator.setup-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="MotorActuator.setup-expanded"><a name="L23"></a><tt class="py-lineno">23</tt>  <tt class="py-line">        <tt class="py-keyword">pass</tt> </tt>
...
<a name="MotorActuator.rotate"></a><div id="MotorActuator.rotate-def"><a name="L26"></a><tt class="py-lineno">26</tt> <a class="py-toggle" href="#" id="MotorActuator.rotate-toggle" onclick="return toggle('MotorActuator.rotate');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.motorActuator.MotorActuator-class.php#rotate">rotate</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="MotorActuator.rotate-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="MotorActuator.rotate-expanded"><a name="L27"></a><tt class="py-lineno">27</tt>  <tt class="py-line">        <tt class="py-docstring">"""Rotate the motor."""</tt> </tt>
...
<a name="MotorActuator.setDirection"></a><div id="MotorActuator.setDirection-def"><a name="L31"></a><tt class="py-lineno">31</tt> <a class="py-toggle" href="#" id="MotorActuator.setDirection-toggle" onclick="return toggle('MotorActuator.setDirection');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.motorActuator.MotorActuator-class.php#setDirection">setDirection</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="MotorActuator.setDirection-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="MotorActuator.setDirection-expanded"><a name="L32"></a><tt class="py-lineno">32</tt>  <tt class="py-line">        <tt class="py-docstring">"""Sets the rotaction direction."""</tt> </tt>
