...
<head>
  <title>libsensorPy.abstractclass.motionSensor</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.abstractclass.motionSensor-pysrc.php"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.abstractclass.motionSensor-module.php">Module libsensorPy.abstractclass.motionSensor</a></h1>
<pre class="py-src">
...
<a name="MotionSensor"></a><div id="MotionSensor-def"><a name="L8"></a><tt class="py-lineno"> 8</tt>  <tt class="py-line"> </tt>
<a name="L9"></a><tt class="py-lineno"> 9</tt> <a class="py-toggle" href="#" id="MotionSensor-toggle" onclick="return toggle('MotionSensor');">-</a><tt class="py-line"><tt class="py-keyword">class</tt> <a class="py-def-name" href="libsensorPy.abstractclass.motionSensor.MotionSensor-class.php">MotionSensor</a><tt class="py-op">(</tt><tt class="py-base-class">Sensor</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="MotionSensor-collapsed" style="display:none;" pad="++" indent="++++"></div><div id="MotionSensor-expanded"><a name="L10"></a><tt class="py-lineno">10</tt>  <tt class="py-line"> </tt>
...
<a name="MotionSensor.setup"></a><div id="MotionSensor.setup-def"><a name="L23"></a><tt class="py-lineno">23</tt> <a class="py-toggle" href="#" id="MotionSensor.setup-toggle" onclick="return toggle('MotionSensor.setup');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.motionSensor.MotionSensor-class.php#setup">setup</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="MotionSensor.setup-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="MotionSensor.setup-expanded"><a name="L24"></a><tt class="py-lineno">24</tt>  <tt class="py-line">        <tt class="py-keyword">pass</tt> </tt>
...
<a name="MotionSensor.isMotionDetected"></a><div id="MotionSensor.isMotionDetected-def"><a name="L27"></a><tt class="py-lineno">27</tt> <a class="py-toggle" href="#" id="MotionSensor.isMotionDetected-toggle" onclick="return toggle('MotionSensor.isMotionDetected');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.motionSensor.MotionSensor-class.php#isMotionDetected">isMotionDetected</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="MotionSensor.isMotionDetected-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="MotionSensor.isMotionDetected-expanded"><a name="L28"></a><tt class="py-lineno">28</tt>  <tt class="py-line">        <tt class="py-docstring">"""Retrieve data from the input source and return an object."""</tt> </tt>
