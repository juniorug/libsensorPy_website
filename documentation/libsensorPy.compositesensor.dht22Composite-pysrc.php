...
<head>
  <title>libsensorPy.compositesensor.dht22Composite</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.compositesensor.dht22Composite-pysrc.php"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.compositesensor.dht22Composite-module.php">Module libsensorPy.compositesensor.dht22Composite</a></h1>
<pre class="py-src">
...
<a name="L8"></a><tt class="py-lineno"> 8</tt>  <tt class="py-line"><tt class="py-keyword">from</tt> <tt id="link-6" class="py-name" targets="Package libsensorPy.concretesensor=libsensorPy.concretesensor-module.php"><a title="libsensorPy.concretesensor" class="py-name" href="#" onclick="return doclink('link-6', 'concretesensor', 'link-6');">concretesensor</a></tt><tt class="py-op">.</tt><tt id="link-7" class="py-name" targets="Module libsensorPy.concretesensor.dht22Humidity=libsensorPy.concretesensor.dht22Humidity-module.php"><a title="libsensorPy.concretesensor.dht22Humidity" class="py-name" href="#" onclick="return doclink('link-7', 'dht22Humidity', 'link-7');">dht22Humidity</a></tt> <tt class="py-keyword">import</tt> <tt id="link-8" class="py-name" targets="Class libsensorPy.concretesensor.dht22Humidity.DHT22Humidity=libsensorPy.concretesensor.dht22Humidity.DHT22Humidity-class.php"><a title="libsensorPy.concretesensor.dht22Humidity.DHT22Humidity" class="py-name" href="#" onclick="return doclink('link-8', 'DHT22Humidity', 'link-8');">DHT22Humidity</a></tt> </tt>
<a name="L9"></a><tt class="py-lineno"> 9</tt>  <tt class="py-line"><tt class="py-keyword">from</tt> <tt id="link-9" class="py-name"><a title="libsensorPy.concretesensor" class="py-name" href="#" onclick="return doclink('link-9', 'concretesensor', 'link-6');">concretesensor</a></tt><tt class="py-op">.</tt><tt id="link-10" class="py-name" targets="Module libsensorPy.concretesensor.dht22Temperature=libsensorPy.concretesensor.dht22Temperature-module.php"><a title="libsensorPy.concretesensor.dht22Temperature" class="py-name" href="#" onclick="return doclink('link-10', 'dht22Temperature', 'link-10');">dht22Temperature</a></tt> <tt class="py-keyword">import</tt> <tt id="link-11" class="py-name" targets="Class libsensorPy.concretesensor.dht22Temperature.DHT22Temperature=libsensorPy.concretesensor.dht22Temperature.DHT22Temperature-class.php"><a title="libsensorPy.concretesensor.dht22Temperature.DHT22Temperature" class="py-name" href="#" onclick="return doclink('link-11', 'DHT22Temperature', 'link-11');">DHT22Temperature</a></tt> </tt>
<a name="L10"></a><tt class="py-lineno">10</tt>  <tt class="py-line"> </tt>
<a name="DHT22Composite"></a><div id="DHT22Composite-def"><a name="L11"></a><tt class="py-lineno">11</tt> <a class="py-toggle" href="#" id="DHT22Composite-toggle" onclick="return toggle('DHT22Composite');">-</a><tt class="py-line"><tt class="py-keyword">class</tt> <a class="py-def-name" href="libsensorPy.compositesensor.dht22Composite.DHT22Composite-class.php">DHT22Composite</a><tt class="py-op">(</tt><tt class="py-base-class">TemperatureSensor</tt><tt class="py-op">,</tt><tt class="py-base-class">HumiditySensor</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="DHT22Composite-collapsed" style="display:none;" pad="++" indent="++++"></div><div id="DHT22Composite-expanded"><a name="L12"></a><tt class="py-lineno">12</tt>  <tt class="py-line">    <tt class="py-docstring">'''</tt> </tt>
<a name="L13"></a><tt class="py-lineno">13</tt>  <tt class="py-line"><tt class="py-docstring">    classdocs</tt> </tt>
<a name="L14"></a><tt class="py-lineno">14</tt>  <tt class="py-line"><tt class="py-docstring">    '''</tt> </tt>
<a name="L15"></a><tt class="py-lineno">15</tt>  <tt class="py-line"> </tt>
<a name="DHT22Composite.__init__"></a><div id="DHT22Composite.__init__-def"><a name="L16"></a><tt class="py-lineno">16</tt> <a class="py-toggle" href="#" id="DHT22Composite.__init__-toggle" onclick="return toggle('DHT22Composite.__init__');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.compositesensor.dht22Composite.DHT22Composite-class.php#__init__">__init__</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="DHT22Composite.__init__-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="DHT22Composite.__init__-expanded"><a name="L17"></a><tt class="py-lineno">17</tt>  <tt class="py-line">        <tt class="py-docstring">'''</tt> </tt>
...
<a name="DHT22Composite.changeSetup"></a><div id="DHT22Composite.changeSetup-def"><a name="L29"></a><tt class="py-lineno">29</tt> <a class="py-toggle" href="#" id="DHT22Composite.changeSetup-toggle" onclick="return toggle('DHT22Composite.changeSetup');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.compositesensor.dht22Composite.DHT22Composite-class.php#changeSetup">changeSetup</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">,</tt><tt class="py-param">pin</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="DHT22Composite.changeSetup-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="DHT22Composite.changeSetup-expanded"><a name="L30"></a><tt class="py-lineno">30</tt>  <tt class="py-line">        <tt class="py-docstring">"""</tt> </tt>
...
<a name="DHT22Composite.getTemperatureInFahrenheit"></a><div id="DHT22Composite.getTemperatureInFahrenheit-def"><a name="L41"></a><tt class="py-lineno">41</tt> <a class="py-toggle" href="#" id="DHT22Composite.getTemperatureInFahrenheit-toggle" onclick="return toggle('DHT22Composite.getTemperatureInFahrenheit');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.compositesensor.dht22Composite.DHT22Composite-class.php#getTemperatureInFahrenheit">getTemperatureInFahrenheit</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="DHT22Composite.getTemperatureInFahrenheit-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="DHT22Composite.getTemperatureInFahrenheit-expanded"><a name="L42"></a><tt class="py-lineno">42</tt>  <tt class="py-line">        <tt class="py-docstring">"""Return the temperature in Fahrenheit measured from the sensor."""</tt> </tt>
<a name="L43"></a><tt class="py-lineno">43</tt>  <tt class="py-line">        <tt class="py-keyword">return</tt> <tt class="py-name">self</tt><tt class="py-op">.</tt><tt class="py-name">__dht22Temp</tt><tt class="py-op">.</tt><tt id="link-21" class="py-name" targets="Method libsensorPy.abstractclass.temperatureSensor.TemperatureSensor.getTemperatureInFahrenheit()=libsensorPy.abstractclass.temperatureSensor.TemperatureSensor-class.php#getTemperatureInFahrenheit,Method libsensorPy.compositesensor.bmp085Composite.BMP085Composite.getTemperatureInFahrenheit()=libsensorPy.compositesensor.bmp085Composite.BMP085Composite-class.php#getTemperatureInFahrenheit,Method libsensorPy.compositesensor.dht11Composite.DHT11Composite.getTemperatureInFahrenheit()=libsensorPy.compositesensor.dht11Composite.DHT11Composite-class.php#getTemperatureInFahrenheit,Method libsensorPy.compositesensor.dht22Composite.DHT22Composite.getTemperatureInFahrenheit()=libsensorPy.compositesensor.dht22Composite.DHT22Composite-class.php#getTemperatureInFahrenheit"><a title="libsensorPy.abstractclass.temperatureSensor.TemperatureSensor.getTemperatureInFahrenheit
...
<a name="DHT22Composite.getTemperatureInKelvin"></a><div id="DHT22Composite.getTemperatureInKelvin-def"><a name="L45"></a><tt class="py-lineno">45</tt> <a class="py-toggle" href="#" id="DHT22Composite.getTemperatureInKelvin-toggle" onclick="return toggle('DHT22Composite.getTemperatureInKelvin');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.compositesensor.dht22Composite.DHT22Composite-class.php#getTemperatureInKelvin">getTemperatureInKelvin</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="DHT22Composite.getTemperatureInKelvin-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="DHT22Composite.getTemperatureInKelvin-expanded"><a name="L46"></a><tt class="py-lineno">46</tt>  <tt class="py-line">        <tt class="py-docstring">"""Return the temperature in Kelvin measured from the sensor."""</tt> </tt>
<a name="L47"></a><tt class="py-lineno">47</tt>  <tt class="py-line">        <tt class="py-keyword">return</tt> <tt class="py-name">self</tt><tt class="py-op">.</tt><tt class="py-name">__dht22Temp</tt><tt class="py-op">.</tt><tt id="link-22" class="py-name" targets="Method libsensorPy.abstractclass.temperatureSensor.TemperatureSensor.getTemperatureInKelvin()=libsensorPy.abstractclass.temperatureSensor.TemperatureSensor-class.php#getTemperatureInKelvin,Method libsensorPy.compositesensor.bmp085Composite.BMP085Composite.getTemperatureInKelvin()=libsensorPy.compositesensor.bmp085Composite.BMP085Composite-class.php#getTemperatureInKelvin,Method libsensorPy.compositesensor.dht11Composite.DHT11Composite.getTemperatureInKelvin()=libsensorPy.compositesensor.dht11Composite.DHT11Composite-class.php#getTemperatureInKelvin,Method libsensorPy.compositesensor.dht22Composite.DHT22Composite.getTemperatureInKelvin()=libsensorPy.compositesensor.dht22Composite.DHT22Composite-class.php#getTemperatureInKelvin"><a title="libsensorPy.abstractclass.temperatureSensor.TemperatureSensor.getTemperatureInKelvin
...
<a name="DHT22Composite.getHumidity"></a><div id="DHT22Composite.getHumidity-def"><a name="L49"></a><tt class="py-lineno">49</tt> <a class="py-toggle" href="#" id="DHT22Composite.getHumidity-toggle" onclick="return toggle('DHT22Composite.getHumidity');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.compositesensor.dht22Composite.DHT22Composite-class.php#getHumidity">getHumidity</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="DHT22Composite.getHumidity-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="DHT22Composite.getHumidity-expanded"><a name="L50"></a><tt class="py-lineno">50</tt>  <tt class="py-line">        <tt class="py-docstring">"""Return the humidity measured from the sensor."""</tt> </tt>
<a name="L51"></a><tt class="py-lineno">51</tt>  <tt class="py-line">        <tt class="py-keyword">return</tt> <tt class="py-name">self</tt><tt class="py-op">.</tt><tt class="py-name">__dht22Hum</tt><tt class="py-op">.</tt><tt id="link-23" class="py-name" targets="Method libsensorPy.abstractclass.humiditySensor.HumiditySensor.getHumidity()=libsensorPy.abstractclass.humiditySensor.HumiditySensor-class.php#getHumidity,Method libsensorPy.compositesensor.dht11Composite.DHT11Composite.getHumidity()=libsensorPy.compositesensor.dht11Composite.DHT11Composite-class.php#getHumidity,Method libsensorPy.compositesensor.dht22Composite.DHT22Composite.getHumidity()=libsensorPy.compositesensor.dht22Composite.DHT22Composite-class.php#getHumidity,Method libsensorPy.concretesensor.dht11Humidity.DHT11Humidity.getHumidity()=libsensorPy.concretesensor.dht11Humidity.DHT11Humidity-class.php#getHumidity,Method libsensorPy.concretesensor.dht22Humidity.DHT22Humidity.getHumidity()=libsensorPy.concretesensor.dht22Humidity.DHT22Humidity-class.php#getHumidity"><a title="libsensorPy.abstractclass.humiditySensor.HumiditySensor.getHumidity
...
<a name="DHT22Composite.add"></a><div id="DHT22Composite.add-def"><a name="L53"></a><tt class="py-lineno">53</tt> <a class="py-toggle" href="#" id="DHT22Composite.add-toggle" onclick="return toggle('DHT22Composite.add');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.compositesensor.dht22Composite.DHT22Composite-class.php#add">add</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">,</tt><tt class="py-param">sensor</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="DHT22Composite.add-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="DHT22Composite.add-expanded"><a name="L54"></a><tt class="py-lineno">54</tt>  <tt class="py-line">        <tt class="py-docstring">"""</tt> </tt>
<a name="L55"></a><tt class="py-lineno">55</tt>  <tt class="py-line"><tt class="py-docstring">        Add a basic sensor to the composite</tt> </tt>
<a name="L56"></a><tt class="py-lineno">56</tt>  <tt class="py-line"><tt class="py-docstring">        @param sensor: The sensor to be added</tt> </tt>
<a name="L57"></a><tt class="py-lineno">57</tt>  <tt class="py-line"><tt class="py-docstring">        @type sensor: Sensor</tt> </tt>
<a name="L58"></a><tt class="py-lineno">58</tt>  <tt class="py-line"><tt class="py-docstring">        """</tt> </tt>
<a name="L59"></a><tt class="py-lineno">59</tt>  <tt class="py-line">         </tt>
<a name="L60"></a><tt class="py-lineno">60</tt>  <tt class="py-line">        <tt class="py-keyword">if</tt> <tt class="py-op">(</tt> <tt class="py-name">isinstance</tt><tt class="py-op">(</tt><tt id="link-24" class="py-name" targets="Module libsensorPy.abstractclass.sensor=libsensorPy.abstractclass.sensor-module.php"><a title="libsensorPy.abstractclass.sensor" class="py-name" href="#" onclick="return doclink('link-24', 'sensor', 'link-24');">sensor</a></tt><tt class="py-op">,</tt> <tt id="link-25" class="py-name"><a title="libsensorPy.concretesensor.dht22Temperature.DHT22Temperature" class="py-name" href="#" onclick="return doclink('link-25', 'DHT22Temperature', 'link-11');">DHT22Temperature</a></tt><tt class="py-op">)</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
<a name="L61"></a><tt class="py-lineno">61</tt>  <tt class="py-line">            <tt class="py-name">self</tt><tt class="py-op">.</tt><tt class="py-name">__dht22Temp</tt> <tt class="py-op">=</tt> <tt id="link-26" class="py-name"><a title="libsensorPy.abstractclass.sensor" class="py-name" href="#" onclick="return doclink('link-26', 'sensor', 'link-24');">sensor</a></tt> </tt>
<a name="L62"></a><tt class="py-lineno">62</tt>  <tt class="py-line">        <tt class="py-keyword">elif</tt> <tt class="py-op">(</tt> <tt class="py-name">isinstance</tt><tt class="py-op">(</tt><tt id="link-27" class="py-name"><a title="libsensorPy.abstractclass.sensor" class="py-name" href="#" onclick="return doclink('link-27', 'sensor', 'link-24');">sensor</a></tt><tt class="py-op">,</tt> <tt id="link-28" class="py-name"><a title="libsensorPy.concretesensor.dht22Humidity.DHT22Humidity" class="py-name" href="#" onclick="return doclink('link-28', 'DHT22Humidity', 'link-8');">DHT22Humidity</a></tt><tt class="py-op">)</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
<a name="L63"></a><tt class="py-lineno">63</tt>  <tt class="py-line">            <tt class="py-name">self</tt><tt class="py-op">.</tt><tt class="py-name">__dht22Hum</tt> <tt class="py-op">=</tt> <tt id="link-29" class="py-name"><a title="libsensorPy.abstractclass.sensor" class="py-name" href="#" onclick="return doclink('link-29', 'sensor', 'link-24');">sensor</a></tt> </tt>
<a name="L64"></a><tt class="py-lineno">64</tt>  <tt class="py-line">        <tt class="py-keyword">else</tt><tt class="py-op">:</tt> </tt>
<a name="L65"></a><tt class="py-lineno">65</tt>  <tt class="py-line">            <tt class="py-keyword">assert</tt> <tt class="py-number">0</tt><tt class="py-op">,</tt> <tt class="py-string">"Bad sensor creation. "</tt> </tt>
