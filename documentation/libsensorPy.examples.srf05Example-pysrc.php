...
<head>
  <title>libsensorPy.examples.srf05Example</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.examples.srf05Example-pysrc.php"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.examples.srf05Example-module.php">Module libsensorPy.examples.srf05Example</a></h1>
<pre class="py-src">
...
<a name="L13"></a><tt class="py-lineno">13</tt>  <tt class="py-line">    <tt class="py-keyword">print</tt> <tt class="py-op">(</tt><tt class="py-string">"Distance in inches:"</tt> <tt class="py-op">+</tt> <tt id="link-8" class="py-name"><a title="libsensorPy.concretesensor.srf05" class="py-name" href="#" onclick="return doclink('link-8', 'srf05', 'link-3');">srf05</a></tt><tt class="py-op">.</tt><tt id="link-9" class="py-name" targets="Method libsensorPy.abstractclass.ultrasonicSensor.UltrasonicSensor.distance_in_inches()=libsensorPy.abstractclass.ultrasonicSensor.UltrasonicSensor-class.php#distance_in_inches"><a title="libsensorPy.abstractclass.ultrasonicSensor.UltrasonicSensor.distance_in_inches" class="py-name" href="#" onclick="return doclink('link-9', 'distance_in_inches', 'link-9');">distance_in_inches</a></tt><tt class="py-op">(</tt><tt class="py-op">)</tt> <tt class="py-op">+</tt> <tt class="py-string">" in"</tt><tt class="py-op">)</tt> </tt>
