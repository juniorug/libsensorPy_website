...
<head>
  <title>libsensorPy.concretesensor.dht22Humidity.DHT22Humidity</title>
  ...
  <tr valign="top">
    <td width="100%">
      <span class="breadcrumbs">
        ...
        <a href="libsensorPy.concretesensor.dht22Humidity-module.php">Module&nbsp;dht22Humidity</a> ::
        Class&nbsp;DHT22Humidity
      </span>
    </td>
    <td>
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.concretesensor.dht22Humidity.DHT22Humidity-class.php"
...
<!-- ==================== CLASS DESCRIPTION ==================== -->
<h1 class="epydoc">Class DHT22Humidity</h1><p class="nomargin-top"><span class="codelink"><a href="libsensorPy.concretesensor.dht22Humidity-pysrc.php#DHT22Humidity">source&nbsp;code</a></span></p>
<center>
<center>  <map id="uml_class_diagram_for_libsenso_44" name="uml_class_diagram_for_libsenso_44">
<area shape="rect" id="node102" href="libsensorPy.concretesensor.dht22Humidity.DHT22Humidity-class.php#__init__" title="Constructor" alt="" coords="84,193,221,212"/>
<area shape="rect" id="node102" href="libsensorPy.concretesensor.dht22Humidity.DHT22Humidity-class.php#setup" title="Setup the board and GPIO" alt="" coords="84,212,221,231"/>
<area shape="rect" id="node102" href="libsensorPy.concretesensor.dht22Humidity.DHT22Humidity-class.php#changeSetup" title="Returns: &#160;void" alt="" coords="84,231,221,249"/>
<area shape="rect" id="node102" href="libsensorPy.concretesensor.dht22Humidity.DHT22Humidity-class.php#getHumidity" title="Gets the humidity from the sensor" alt="" coords="84,249,221,268"/>
<area shape="rect" id="node1" href="libsensorPy.concretesensor.dht22Humidity.DHT22Humidity-class.php" title="classdocs" alt="" coords="72,161,232,274"/>
<area shape="rect" id="node103" href="libsensorPy.abstractclass.humiditySensor.HumiditySensor-class.php#__metaclass__" title="libsensorPy.abstractclass.humiditySensor.HumiditySensor.__metaclass__" alt="" coords="17,108,288,127"/>
...
<area shape="rect" id="node104" href="libsensorPy.abstractclass.sensor.Sensor-class.php#__del__" title="We&#39;re no longer using the GPIO, so tell software we&#39;re done." alt="" coords="69,39,237,57"/>
<area shape="rect" id="node3" href="libsensorPy.abstractclass.sensor.Sensor-class.php" title="classdocs" alt="" coords="57,6,249,63"/>
</map>
  <img src="<?=$siteUrl?>/img/uml/uml_class_diagram_for_libsenso_44.gif" alt='' usemap="#uml_class_diagram_for_libsenso_44" ismap="ismap" class="graph-without-title" />
</center>
</center>
<hr />
<p>classdocs</p>
...
<div class="panel panel-info">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="libsensorPy.concretesensor.dht22Humidity.DHT22Humidity-class.php#__init__" class="summary-sig-name">__init__</a>(<span class="summary-sig-arg">self</span>)</span><br />
      Constructor</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="libsensorPy.concretesensor.dht22Humidity-pysrc.php#DHT22Humidity.__init__">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="libsensorPy.concretesensor.dht22Humidity.DHT22Humidity-class.php#setup" class="summary-sig-name">setup</a>(<span class="summary-sig-arg">self</span>)</span><br />
      Setup the board and GPIO</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="libsensorPy.concretesensor.dht22Humidity-pysrc.php#DHT22Humidity.setup">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="libsensorPy.concretesensor.dht22Humidity.DHT22Humidity-class.php#changeSetup" class="summary-sig-name">changeSetup</a>(<span class="summary-sig-arg">self</span>,
        <span class="summary-sig-arg">pin</span>)</span><br />
      Returns:
      void</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="libsensorPy.concretesensor.dht22Humidity-pysrc.php#DHT22Humidity.changeSetup">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="libsensorPy.concretesensor.dht22Humidity.DHT22Humidity-class.php#__cb" class="summary-sig-name" onclick="show_private();">__cb</a>(<span class="summary-sig-arg">self</span>,
      ...
      Accumulate the 40 data bits.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="libsensorPy.concretesensor.dht22Humidity-pysrc.php#DHT22Humidity.__cb">source&nbsp;code</a></span>
...
<tr>
    <td width="15%" align="right" valign="top" class="summary">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td><span class="summary-sig"><a href="libsensorPy.concretesensor.dht22Humidity.DHT22Humidity-class.php#getHumidity" class="summary-sig-name">getHumidity</a>(<span class="summary-sig-arg">self</span>)</span><br />
      Gets the humidity from the sensor</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="libsensorPy.concretesensor.dht22Humidity-pysrc.php#DHT22Humidity.getHumidity">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      Trigger a new relative humidity and temperature reading.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="libsensorPy.concretesensor.dht22Humidity-pysrc.php#DHT22Humidity.__trigger">source&nbsp;code</a></span>
...
<tr class="private">
    <td width="15%" align="right" valign="top" class="summary">
      ...
      Cancel the DHT22 sensor.</td>
          <td align="right" valign="top">
            <span class="codelink"><a href="libsensorPy.concretesensor.dht22Humidity-pysrc.php#DHT22Humidity.__cancel">source&nbsp;code</a></span>
...
<tr><td>
  ...
  <p>Gets the humidity from the sensor</p>
  <dl class="fields">
    <dt>Returns: float</dt>
