...
<head>
  <title>libsensorPy.abstractclass.abstractSensorFactory</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.abstractclass.abstractSensorFactory-pysrc.php"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.abstractclass.abstractSensorFactory-module.php">Module libsensorPy.abstractclass.abstractSensorFactory</a></h1>
<pre class="py-src">
...
<a name="AbstractSensorFactory"></a><div id="AbstractSensorFactory-def"><a name="L7"></a><tt class="py-lineno"> 7</tt>  <tt class="py-line"> </tt>
<a name="L8"></a><tt class="py-lineno"> 8</tt> <a class="py-toggle" href="#" id="AbstractSensorFactory-toggle" onclick="return toggle('AbstractSensorFactory');">-</a><tt class="py-line"><tt class="py-keyword">class</tt> <a class="py-def-name" href="libsensorPy.abstractclass.abstractSensorFactory.AbstractSensorFactory-class.php">AbstractSensorFactory</a><tt class="py-op">(</tt><tt class="py-base-class">object</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="AbstractSensorFactory-collapsed" style="display:none;" pad="++" indent="++++"></div><div id="AbstractSensorFactory-expanded"><a name="L9"></a><tt class="py-lineno"> 9</tt>  <tt class="py-line">    <tt class="py-docstring">'''</tt> </tt>
...
<a name="AbstractSensorFactory.__init__"></a><div id="AbstractSensorFactory.__init__-def"><a name="L14"></a><tt class="py-lineno">14</tt> <a class="py-toggle" href="#" id="AbstractSensorFactory.__init__-toggle" onclick="return toggle('AbstractSensorFactory.__init__');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.abstractSensorFactory.AbstractSensorFactory-class.php#__init__">__init__</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="AbstractSensorFactory.__init__-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="AbstractSensorFactory.__init__-expanded"><a name="L15"></a><tt class="py-lineno">15</tt>  <tt class="py-line">        <tt class="py-docstring">'''</tt> </tt>
...
<a name="AbstractSensorFactory.createSensor"></a><div id="AbstractSensorFactory.createSensor-def"><a name="L20"></a><tt class="py-lineno">20</tt> <a class="py-toggle" href="#" id="AbstractSensorFactory.createSensor-toggle" onclick="return toggle('AbstractSensorFactory.createSensor');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.abstractSensorFactory.AbstractSensorFactory-class.php#createSensor">createSensor</a><tt class="py-op">(</tt><tt class="py-param">sensorType</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="AbstractSensorFactory.createSensor-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="AbstractSensorFactory.createSensor-expanded"><a name="L21"></a><tt class="py-lineno">21</tt>  <tt class="py-line">        <tt class="py-docstring">"""Retrieve data from the input source and return a Sensor object.</tt> </tt>
<a name="L22"></a><tt class="py-lineno">22</tt>  <tt class="py-line"><tt class="py-docstring">        @param sensorType: The kind of sensor to be created</tt> </tt>
<a name="L23"></a><tt class="py-lineno">23</tt>  <tt class="py-line"><tt class="py-docstring">        @type sensorType: String</tt> </tt>
...
<a name="AbstractSensorFactory.createEvent"></a><div id="AbstractSensorFactory.createEvent-def"><a name="L28"></a><tt class="py-lineno">28</tt> <a class="py-toggle" href="#" id="AbstractSensorFactory.createEvent-toggle" onclick="return toggle('AbstractSensorFactory.createEvent');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.abstractSensorFactory.AbstractSensorFactory-class.php#createEvent">createEvent</a><tt class="py-op">(</tt><tt class="py-param">sensorType</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="AbstractSensorFactory.createEvent-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="AbstractSensorFactory.createEvent-expanded"><a name="L29"></a><tt class="py-lineno">29</tt>  <tt class="py-line">        <tt class="py-docstring">"""Retrieve data from the input source and return an Event object.</tt> </tt>
<a name="L30"></a><tt class="py-lineno">30</tt>  <tt class="py-line"><tt class="py-docstring">        @param sensorType: The kind of sensor to be used by the event</tt> </tt>
<a name="L31"></a><tt class="py-lineno">31</tt>  <tt class="py-line"><tt class="py-docstring">        @type sensorType: String</tt> </tt>
