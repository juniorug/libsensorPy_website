...
<head>
  <title>libsensorPy.abstractclass.lightSensor</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.abstractclass.lightSensor-pysrc.php"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.abstractclass.lightSensor-module.php">Module libsensorPy.abstractclass.lightSensor</a></h1>
<pre class="py-src">
...
<a name="LightSensor"></a><div id="LightSensor-def"><a name="L8"></a><tt class="py-lineno"> 8</tt>  <tt class="py-line"> </tt>
<a name="L9"></a><tt class="py-lineno"> 9</tt> <a class="py-toggle" href="#" id="LightSensor-toggle" onclick="return toggle('LightSensor');">-</a><tt class="py-line"><tt class="py-keyword">class</tt> <a class="py-def-name" href="libsensorPy.abstractclass.lightSensor.LightSensor-class.php">LightSensor</a><tt class="py-op">(</tt><tt class="py-base-class">Sensor</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="LightSensor-collapsed" style="display:none;" pad="++" indent="++++"></div><div id="LightSensor-expanded"><a name="L10"></a><tt class="py-lineno">10</tt>  <tt class="py-line">    <tt class="py-docstring">'''</tt> </tt>
...
<a name="LightSensor.__init__"></a><div id="LightSensor.__init__-def"><a name="L15"></a><tt class="py-lineno">15</tt> <a class="py-toggle" href="#" id="LightSensor.__init__-toggle" onclick="return toggle('LightSensor.__init__');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.lightSensor.LightSensor-class.php#__init__">__init__</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="LightSensor.__init__-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="LightSensor.__init__-expanded"><a name="L16"></a><tt class="py-lineno">16</tt>  <tt class="py-line">        <tt class="py-docstring">'''</tt> </tt>
...
<a name="LightSensor.setup"></a><div id="LightSensor.setup-def"><a name="L22"></a><tt class="py-lineno">22</tt> <a class="py-toggle" href="#" id="LightSensor.setup-toggle" onclick="return toggle('LightSensor.setup');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.lightSensor.LightSensor-class.php#setup">setup</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="LightSensor.setup-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="LightSensor.setup-expanded"><a name="L23"></a><tt class="py-lineno">23</tt>  <tt class="py-line">        <tt class="py-keyword">pass</tt> </tt>
...
<a name="LightSensor.getLux"></a><div id="LightSensor.getLux-def"><a name="L26"></a><tt class="py-lineno">26</tt> <a class="py-toggle" href="#" id="LightSensor.getLux-toggle" onclick="return toggle('LightSensor.getLux');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.lightSensor.LightSensor-class.php#getLux">getLux</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="LightSensor.getLux-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="LightSensor.getLux-expanded"><a name="L27"></a><tt class="py-lineno">27</tt>  <tt class="py-line">        <tt class="py-docstring">"""Return the light in Lux."""</tt> </tt>
...
<a name="LightSensor.getColorTemperature"></a><div id="LightSensor.getColorTemperature-def"><a name="L31"></a><tt class="py-lineno">31</tt> <a class="py-toggle" href="#" id="LightSensor.getColorTemperature-toggle" onclick="return toggle('LightSensor.getColorTemperature');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.lightSensor.LightSensor-class.php#getColorTemperature">getColorTemperature</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="LightSensor.getColorTemperature-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="LightSensor.getColorTemperature-expanded"><a name="L32"></a><tt class="py-lineno">32</tt>  <tt class="py-line">        <tt class="py-docstring">"""Return the color temperature in celsius."""</tt> </tt>
<a name="L33"></a><tt class="py-lineno">33</tt>  <tt class="py-line">        <tt class="py-keyword">pass</tt> </tt>
</div><a name="L34"></a><tt class="py-lineno">34</tt>  <tt class="py-line"> </tt>
<a name="LightSensor.getColorTemperatureInKelvin"></a><div id="LightSensor.getColorTemperatureInKelvin-def"><a name="L35"></a><tt class="py-lineno">35</tt> <a class="py-toggle" href="#" id="LightSensor.getColorTemperatureInKelvin-toggle" onclick="return toggle('LightSensor.getColorTemperatureInKelvin');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.lightSensor.LightSensor-class.php#getColorTemperatureInKelvin">getColorTemperatureInKelvin</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="LightSensor.getColorTemperatureInKelvin-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="LightSensor.getColorTemperatureInKelvin-expanded"><a name="L36"></a><tt class="py-lineno">36</tt>  <tt class="py-line">        <tt class="py-docstring">"""Return the temperature in Kelvin."""</tt> </tt>
<a name="L37"></a><tt class="py-lineno">37</tt>  <tt class="py-line">        <tt class="py-keyword">return</tt> <tt class="py-name">str</tt><tt class="py-op">(</tt><tt class="py-op">(</tt><tt class="py-name">float</tt><tt class="py-op">(</tt><tt class="py-name">self</tt><tt class="py-op">.</tt><tt id="link-6" class="py-name" targets="Method libsensorPy.abstractclass.lightSensor.LightSensor.getColorTemperature()=libsensorPy.abstractclass.lightSensor.LightSensor-class.php#getColorTemperature"><a title="libsensorPy.abstractclass.lightSensor.LightSensor.getColorTemperature" class="py-name" href="#" onclick="return doclink('link-6', 'getColorTemperature', 'link-6');">getColorTemperature</a></tt><tt class="py-op">(</tt><tt class="py-op">)</tt><tt class="py-op">)</tt> <tt class="py-op">+</tt> <tt class="py-number">273.15</tt><tt class="py-op">)</tt><tt class="py-op">)</tt> </tt>
