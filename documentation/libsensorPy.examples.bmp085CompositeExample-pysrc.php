...
<head>
  <title>libsensorPy.examples.bmp085CompositeExample</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.examples.bmp085CompositeExample-pysrc.php"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.examples.bmp085CompositeExample-module.php">Module libsensorPy.examples.bmp085CompositeExample</a></h1>
<pre class="py-src">
...
libsensorPy.extension.extendedUltrasonicSensorFactory.ExtendedUltrasonicSensorFactory.createSensor" class="py-name" href="#" onclick="return doclink('link-4', 'createSensor', 'link-4');">createSensor</a></tt><tt class="py-op">(</tt><tt class="py-string">"BMP085Composite"</tt><tt class="py-op">)</tt> </tt>
<a name="L12"></a><tt class="py-lineno">12</tt>  <tt class="py-line">    <tt class="py-name">temp</tt> <tt class="py-op">=</tt> <tt class="py-name">bmp</tt><tt class="py-op">.</tt><tt class="py-name">readTemperature</tt><tt class="py-op">(</tt><tt class="py-op">)</tt> </tt>
<a name="L13"></a><tt class="py-lineno">13</tt>  <tt class="py-line">    <tt class="py-name">pressure</tt> <tt class="py-op">=</tt> <tt class="py-name">bmp</tt><tt class="py-op">.</tt><tt class="py-name">readPressure</tt><tt class="py-op">(</tt><tt class="py-op">)</tt> </tt>
<a name="L14"></a><tt class="py-lineno">14</tt>  <tt class="py-line">    <tt class="py-name">altitude</tt> <tt class="py-op">=</tt> <tt class="py-name">bmp</tt><tt class="py-op">.</tt><tt class="py-name">readAltitude</tt><tt class="py-op">(</tt><tt class="py-op">)</tt> </tt>
<a name="L15"></a><tt class="py-lineno">15</tt>  <tt class="py-line"> </tt>
<a name="L16"></a><tt class="py-lineno">16</tt>  <tt class="py-line">    <tt class="py-keyword">print</tt> <tt class="py-op">(</tt><tt class="py-string">"Temperature: %.2f C"</tt> <tt class="py-op">%</tt> <tt class="py-name">temp</tt><tt class="py-op">)</tt> </tt>
<a name="L17"></a><tt class="py-lineno">17</tt>  <tt class="py-line">    <tt class="py-keyword">print</tt> <tt class="py-op">(</tt><tt class="py-string">"Pressure:    %.2f hPa"</tt> <tt class="py-op">%</tt> <tt class="py-op">(</tt><tt class="py-name">pressure</tt> <tt class="py-op">/</tt> <tt class="py-number">100.0</tt><tt class="py-op">)</tt><tt class="py-op">)</tt> </tt>
<a name="L18"></a><tt class="py-lineno">18</tt>  <tt class="py-line">    <tt class="py-keyword">print</tt> <tt class="py-op">(</tt><tt class="py-string">"Altitude:    %.2f"</tt> <tt class="py-op">%</tt> <tt class="py-name">altitude</tt><tt class="py-op">)</tt> </tt>
