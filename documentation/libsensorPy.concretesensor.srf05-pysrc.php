...
<head>
  <title>libsensorPy.concretesensor.srf05</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.concretesensor.srf05-pysrc.php"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.concretesensor.srf05-module.php">Module libsensorPy.concretesensor.srf05</a></h1>
<pre class="py-src">
...
<a name="SRF05"></a><div id="SRF05-def"><a name="L11"></a><tt class="py-lineno">11</tt> <a class="py-toggle" href="#" id="SRF05-toggle" onclick="return toggle('SRF05');">-</a><tt class="py-line"><tt class="py-keyword">class</tt> <a class="py-def-name" href="libsensorPy.concretesensor.srf05.SRF05-class.php">SRF05</a><tt class="py-op">(</tt><tt class="py-base-class">UltrasonicSensor</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="SRF05-collapsed" style="display:none;" pad="++" indent="++++"></div><div id="SRF05-expanded"><a name="L12"></a><tt class="py-lineno">12</tt>  <tt class="py-line">    <tt class="py-docstring">'''</tt> </tt>
<a name="L13"></a><tt class="py-lineno">13</tt>  <tt class="py-line"><tt class="py-docstring">    classdocs</tt> </tt>
<a name="L14"></a><tt class="py-lineno">14</tt>  <tt class="py-line"><tt class="py-docstring">    '''</tt> </tt>
<a name="L15"></a><tt class="py-lineno">15</tt>  <tt class="py-line"> </tt>
<a name="SRF05.__init__"></a><div id="SRF05.__init__-def"><a name="L16"></a><tt class="py-lineno">16</tt> <a class="py-toggle" href="#" id="SRF05.__init__-toggle" onclick="return toggle('SRF05.__init__');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.concretesensor.srf05.SRF05-class.php#__init__">__init__</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">,</tt><tt class="py-param">trigger</tt><tt class="py-op">=</tt><tt class="py-number">18</tt><tt class="py-op">,</tt><tt class="py-param">echo</tt><tt class="py-op">=</tt><tt class="py-number">27</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="SRF05.__init__-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="SRF05.__init__-expanded"><a name="L17"></a><tt class="py-lineno">17</tt>  <tt class="py-line">        <tt class="py-docstring">'''</tt> </tt>
...
<a name="SRF05.setup"></a><div id="SRF05.setup-def"><a name="L25"></a><tt class="py-lineno">25</tt> <a class="py-toggle" href="#" id="SRF05.setup-toggle" onclick="return toggle('SRF05.setup');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.concretesensor.srf05.SRF05-class.php#setup">setup</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="SRF05.setup-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="SRF05.setup-expanded"><a name="L26"></a><tt class="py-lineno">26</tt>  <tt class="py-line">        <tt class="py-docstring">"""</tt> </tt>
...
<a name="SRF05.changeSetup"></a><div id="SRF05.changeSetup-def"><a name="L42"></a><tt class="py-lineno">42</tt> <a class="py-toggle" href="#" id="SRF05.changeSetup-toggle" onclick="return toggle('SRF05.changeSetup');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.concretesensor.srf05.SRF05-class.php#changeSetup">changeSetup</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">,</tt> <tt class="py-param">trigger</tt><tt class="py-op">,</tt> <tt class="py-param">echo</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="SRF05.changeSetup-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="SRF05.changeSetup-expanded"><a name="L43"></a><tt class="py-lineno">43</tt>  <tt class="py-line">        <tt class="py-docstring">"""</tt> </tt>
...
<a name="SRF05.distance_in_cm"></a><div id="SRF05.distance_in_cm-def"><a name="L51"></a><tt class="py-lineno">51</tt> <a class="py-toggle" href="#" id="SRF05.distance_in_cm-toggle" onclick="return toggle('SRF05.distance_in_cm');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.concretesensor.srf05.SRF05-class.php#distance_in_cm">distance_in_cm</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="SRF05.distance_in_cm-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="SRF05.distance_in_cm-expanded"><a name="L52"></a><tt class="py-lineno">52</tt>  <tt class="py-line">        <tt class="py-docstring">"""</tt> </tt>
