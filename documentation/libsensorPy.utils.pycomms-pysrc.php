  ...
  <tr valign="top">
    <td width="100%">
      <span class="breadcrumbs">
        ...
        <a href="libsensorPy.utils-module.php">Package&nbsp;utils</a> ::
        Module&nbsp;pycomms
      </span>
    </td>
    <td>
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.utils.pycomms-pysrc.php"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.utils.pycomms-module.php">Module libsensorPy.utils.pycomms</a></h1>
<pre class="py-src">
...
<a name="PyComms"></a><div id="PyComms-def"><a name="L13"></a><tt class="py-lineno"> 13</tt> <a class="py-toggle" href="#" id="PyComms-toggle" onclick="return toggle('PyComms');">-</a><tt class="py-line"><tt class="py-keyword">class</tt> <a class="py-def-name" href="libsensorPy.utils.pycomms.PyComms-class.php">PyComms</a><tt class="py-op">:</tt> </tt>
...
<a name="PyComms.__init__"></a><div id="PyComms.__init__-def"><a name="L15"></a><tt class="py-lineno"> 15</tt> <a class="py-toggle" href="#" id="PyComms.__init__-toggle" onclick="return toggle('PyComms.__init__');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.utils.pycomms.PyComms-class.php#__init__">__init__</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">,</tt> <tt class="py-param">address</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="PyComms.__init__-collapsed" style="display:none;" pad="+++" indent="++++++++"></div><div id="PyComms.__init__-expanded"><a name="L16"></a><tt class="py-lineno"> 16</tt>  <tt class="py-line">        <tt class="py-name">self</tt><tt class="py-op">.</tt><tt id="link-0" class="py-name" targets="Variable libsensorPy.concretesensor.adxl345.ADXL345.address=libsensorPy.concretesensor.adxl345.ADXL345-class.php#address"><a title="libsensorPy.concretesensor.adxl345.ADXL345.address" class="py-name" href="#" onclick="return doclink('link-0', 'address', 'link-0');">address</a></tt> <tt class="py-op">=</tt> <tt id="link-1" class="py-name"><a title="libsensorPy.concretesensor.adxl345.ADXL345.address" class="py-name" href="#" onclick="return doclink('link-1', 'address', 'link-0');">address</a></tt> </tt>
...
<a name="PyComms.writeBits"></a><div id="PyComms.writeBits-def"><a name="L61"></a><tt class="py-lineno"> 61</tt> <a class="py-toggle" href="#" id="PyComms.writeBits-toggle" onclick="return toggle('PyComms.writeBits');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.utils.pycomms.PyComms-class.php#writeBits">writeBits</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">,</tt> <tt class="py-param">reg</tt><tt class="py-op">,</tt> <tt class="py-param">bitStart</tt><tt class="py-op">,</tt> <tt class="py-param">length</tt><tt class="py-op">,</tt> <tt class="py-param">data</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
