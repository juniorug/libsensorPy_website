  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.abstractclass.accelerometerSensor-pysrc.php"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.abstractclass.accelerometerSensor-module.php">Module libsensorPy.abstractclass.accelerometerSensor</a></h1>
<pre class="py-src">
...
<a name="L9"></a><tt class="py-lineno"> 9</tt> <a class="py-toggle" href="#" id="AccelerometerSensor-toggle" onclick="return toggle('AccelerometerSensor');">-</a><tt class="py-line"><tt class="py-keyword">class</tt> <a class="py-def-name" href="libsensorPy.abstractclass.accelerometerSensor.AccelerometerSensor-class.php">AccelerometerSensor</a><tt class="py-op">(</tt><tt class="py-base-class">Sensor</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="L15"></a><tt class="py-lineno">15</tt>  <tt class="py-line">    <tt id="link-4" class="py-name" targets="Variable libsensorPy.abstractclass.accelerometerSensor.AccelerometerSensor.EARTH_GRAVITY_MS2=libsensorPy.abstractclass.accelerometerSensor.AccelerometerSensor-class.php#EARTH_GRAVITY_MS2,Variable libsensorPy.concretesensor.adxl345.ADXL345.EARTH_GRAVITY_MS2=libsensorPy.concretesensor.adxl345.ADXL345-class.php#EARTH_GRAVITY_MS2"><a title="libsensorPy.abstractclass.accelerometerSensor.AccelerometerSensor.EARTH_GRAVITY_MS2
...
<a name="AccelerometerSensor.__init__"></a><div id="AccelerometerSensor.__init__-def"><a name="L17"></a><tt class="py-lineno">17</tt> <a class="py-toggle" href="#" id="AccelerometerSensor.__init__-toggle" onclick="return toggle('AccelerometerSensor.__init__');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.accelerometerSensor.AccelerometerSensor-class.php#__init__">__init__</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="AccelerometerSensor.setup"></a><div id="AccelerometerSensor.setup-def"><a name="L24"></a><tt class="py-lineno">24</tt> <a class="py-toggle" href="#" id="AccelerometerSensor.setup-toggle" onclick="return toggle('AccelerometerSensor.setup');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.accelerometerSensor.AccelerometerSensor-class.php#setup">setup</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="AccelerometerSensor.getAxes"></a><div id="AccelerometerSensor.getAxes-def"><a name="L28"></a><tt class="py-lineno">28</tt> <a class="py-toggle" href="#" id="AccelerometerSensor.getAxes-toggle" onclick="return toggle('AccelerometerSensor.getAxes');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.accelerometerSensor.AccelerometerSensor-class.php#getAxes">getAxes</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
...
<a name="AccelerometerSensor.getAxesInMS2"></a><div id="AccelerometerSensor.getAxesInMS2-def"><a name="L32"></a><tt class="py-lineno">32</tt> <a class="py-toggle" href="#" id="AccelerometerSensor.getAxesInMS2-toggle" onclick="return toggle('AccelerometerSensor.getAxesInMS2');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.accelerometerSensor.AccelerometerSensor-class.php#getAxesInMS2">getAxesInMS2</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
