...
<head>
  <title>libsensorPy.abstractclass.humiditySensor</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.abstractclass.humiditySensor-pysrc.php"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.abstractclass.humiditySensor-module.php">Module libsensorPy.abstractclass.humiditySensor</a></h1>
<pre class="py-src">
...
<a name="HumiditySensor"></a><div id="HumiditySensor-def"><a name="L8"></a><tt class="py-lineno"> 8</tt>  <tt class="py-line"> </tt>
<a name="L9"></a><tt class="py-lineno"> 9</tt> <a class="py-toggle" href="#" id="HumiditySensor-toggle" onclick="return toggle('HumiditySensor');">-</a><tt class="py-line"><tt class="py-keyword">class</tt> <a class="py-def-name" href="libsensorPy.abstractclass.humiditySensor.HumiditySensor-class.php">HumiditySensor</a><tt class="py-op">(</tt><tt class="py-base-class">Sensor</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="HumiditySensor-collapsed" style="display:none;" pad="++" indent="++++"></div><div id="HumiditySensor-expanded"><a name="L10"></a><tt class="py-lineno">10</tt>  <tt class="py-line">    <tt class="py-docstring">'''</tt> </tt>
...
<a name="HumiditySensor.__init__"></a><div id="HumiditySensor.__init__-def"><a name="L15"></a><tt class="py-lineno">15</tt> <a class="py-toggle" href="#" id="HumiditySensor.__init__-toggle" onclick="return toggle('HumiditySensor.__init__');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.humiditySensor.HumiditySensor-class.php#__init__">__init__</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="HumiditySensor.__init__-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="HumiditySensor.__init__-expanded"><a name="L16"></a><tt class="py-lineno">16</tt>  <tt class="py-line">        <tt class="py-docstring">'''</tt> </tt>
...
<a name="HumiditySensor.setup"></a><div id="HumiditySensor.setup-def"><a name="L22"></a><tt class="py-lineno">22</tt> <a class="py-toggle" href="#" id="HumiditySensor.setup-toggle" onclick="return toggle('HumiditySensor.setup');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.humiditySensor.HumiditySensor-class.php#setup">setup</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="HumiditySensor.setup-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="HumiditySensor.setup-expanded"><a name="L23"></a><tt class="py-lineno">23</tt>  <tt class="py-line">        <tt class="py-keyword">pass</tt> </tt>
...
<a name="HumiditySensor.getHumidity"></a><div id="HumiditySensor.getHumidity-def"><a name="L26"></a><tt class="py-lineno">26</tt> <a class="py-toggle" href="#" id="HumiditySensor.getHumidity-toggle" onclick="return toggle('HumiditySensor.getHumidity');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.humiditySensor.HumiditySensor-class.php#getHumidity">getHumidity</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="HumiditySensor.getHumidity-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="HumiditySensor.getHumidity-expanded"><a name="L27"></a><tt class="py-lineno">27</tt>  <tt class="py-line">        <tt class="py-docstring">''' Get the humidity value'''</tt> </tt>
...
<a name="HumiditySensor._bin2dec"></a><div id="HumiditySensor._bin2dec-def"><a name="L30"></a><tt class="py-lineno">30</tt> <a class="py-toggle" href="#" id="HumiditySensor._bin2dec-toggle" onclick="return toggle('HumiditySensor._bin2dec');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.humiditySensor.HumiditySensor-class.php#_bin2dec">_bin2dec</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">,</tt><tt class="py-param">string_num</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="HumiditySensor._bin2dec-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="HumiditySensor._bin2dec-expanded"><a name="L31"></a><tt class="py-lineno">31</tt>  <tt class="py-line">        <tt class="py-docstring">''' Convert the value to String'''</tt> </tt>
<a name="L32"></a><tt class="py-lineno">32</tt>  <tt class="py-line">        <tt class="py-keyword">return</tt> <tt class="py-name">str</tt><tt class="py-op">(</tt><tt class="py-name">int</tt><tt class="py-op">(</tt><tt class="py-name">string_num</tt><tt class="py-op">,</tt> <tt class="py-number">2</tt><tt class="py-op">)</tt><tt class="py-op">)</tt> </tt>
