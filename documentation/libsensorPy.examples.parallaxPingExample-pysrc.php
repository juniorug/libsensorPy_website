...
<head>
  <title>libsensorPy.examples.parallaxPingExample</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.examples.parallaxPingExample-pysrc.php"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.examples.parallaxPingExample-module.php">Module libsensorPy.examples.parallaxPingExample</a></h1>
<pre class="py-src">
...
libsensorPy.extension.hcsr04.HCSR04.distance_in_cm" class="py-name" href="#" onclick="return doclink('link-5', 'distance_in_cm', 'link-5');">distance_in_cm</a></tt><tt class="py-op">(</tt><tt class="py-op">)</tt> <tt class="py-op">+</tt> <tt class="py-string">" cm"</tt><tt class="py-op">)</tt> </tt>
<a name="L13"></a><tt class="py-lineno">13</tt>  <tt class="py-line">    <tt class="py-keyword">print</tt> <tt class="py-op">(</tt><tt class="py-string">"Distance in inches:"</tt> <tt class="py-op">+</tt> <tt class="py-name">ping</tt><tt class="py-op">.</tt><tt id="link-6" class="py-name" targets="Method libsensorPy.abstractclass.ultrasonicSensor.UltrasonicSensor.distance_in_inches()=libsensorPy.abstractclass.ultrasonicSensor.UltrasonicSensor-class.php#distance_in_inches"><a title="libsensorPy.abstractclass.ultrasonicSensor.UltrasonicSensor.distance_in_inches" class="py-name" href="#" onclick="return doclink('link-6', 'distance_in_inches', 'link-6');">distance_in_inches</a></tt><tt class="py-op">(</tt><tt class="py-op">)</tt> <tt class="py-op">+</tt> <tt class="py-string">" in"</tt><tt class="py-op">)</tt> </tt>
