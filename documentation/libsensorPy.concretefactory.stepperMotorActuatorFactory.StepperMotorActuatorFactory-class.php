...
<head>
  <title>libsensorPy.concretefactory.stepperMotorActuatorFactory.StepperMotorActuatorFactory</title>
...
<tr><td>
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr valign="top"><td>
  <h3 class="epydoc"><span class="sig"><span class="sig-name">createActuator</span>(<span class="sig-arg">actuatorType</span>)</span>
  ...
  <p>Retrieve data from the input source and return a actuator object.</p>
  <dl class="fields">
    <dt>Parameters:</dt>
...
<tr><td>
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr valign="top"><td>
  <h3 class="epydoc"><span class="sig"><span class="sig-name">createEvent</span>(<span class="sig-arg">actuatorType</span>)</span>
    <br /><em class="fname">Static Method</em>
  </h3>
  </td><td align="right" valign="top"
    ><span class="codelink"><a href="libsensorPy.concretefactory.stepperMotorActuatorFactory-pysrc.php#StepperMotorActuatorFactory.createEvent">source&nbsp;code</a></span>&nbsp;
