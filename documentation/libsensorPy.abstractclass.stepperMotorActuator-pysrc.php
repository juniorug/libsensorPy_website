...
<head>
  <title>libsensorPy.abstractclass.stepperMotorActuator</title>
  ...
  <tr valign="top">
    ...
    onclick="toggle_private();">hide&nbsp;private</a>]</span></td></tr>
        <tr><td align="right"><span class="options"
            ...
            >]&nbsp;|&nbsp;<a href="libsensorPy.abstractclass.stepperMotorActuator-pysrc.php"
            target="_top">no&nbsp;frames</a>]</span></td></tr>
      </table>
    </td>
  </tr>
</table>
<h1 class="epydoc">Source Code for <a href="libsensorPy.abstractclass.stepperMotorActuator-module.php">Module libsensorPy.abstractclass.stepperMotorActuator</a></h1>
<pre class="py-src">
...
<a name="StepperMotorActuator"></a><div id="StepperMotorActuator-def"><a name="L8"></a><tt class="py-lineno"> 8</tt>  <tt class="py-line"> </tt>
<a name="L9"></a><tt class="py-lineno"> 9</tt> <a class="py-toggle" href="#" id="StepperMotorActuator-toggle" onclick="return toggle('StepperMotorActuator');">-</a><tt class="py-line"><tt class="py-keyword">class</tt> <a class="py-def-name" href="libsensorPy.abstractclass.stepperMotorActuator.StepperMotorActuator-class.php">StepperMotorActuator</a><tt class="py-op">(</tt><tt class="py-base-class">MotorActuator</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="StepperMotorActuator-collapsed" style="display:none;" pad="++" indent="++++"></div><div id="StepperMotorActuator-expanded"><a name="L10"></a><tt class="py-lineno">10</tt>  <tt class="py-line">    <tt class="py-docstring">'''</tt> </tt>
...
<a name="StepperMotorActuator.__init__"></a><div id="StepperMotorActuator.__init__-def"><a name="L15"></a><tt class="py-lineno">15</tt> <a class="py-toggle" href="#" id="StepperMotorActuator.__init__-toggle" onclick="return toggle('StepperMotorActuator.__init__');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.stepperMotorActuator.StepperMotorActuator-class.php#__init__">__init__</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="StepperMotorActuator.__init__-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="StepperMotorActuator.__init__-expanded"><a name="L16"></a><tt class="py-lineno">16</tt>  <tt class="py-line">        <tt class="py-docstring">'''</tt> </tt>
...
<a name="StepperMotorActuator.setStepSequence"></a><div id="StepperMotorActuator.setStepSequence-def"><a name="L22"></a><tt class="py-lineno">22</tt> <a class="py-toggle" href="#" id="StepperMotorActuator.setStepSequence-toggle" onclick="return toggle('StepperMotorActuator.setStepSequence');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.stepperMotorActuator.StepperMotorActuator-class.php#setStepSequence">setStepSequence</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">,</tt> <tt class="py-param">stepSequence</tt> <tt class="py-op">=</tt> <tt class="py-number">8</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="StepperMotorActuator.setStepSequence-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="StepperMotorActuator.setStepSequence-expanded"><a name="L23"></a><tt class="py-lineno">23</tt>  <tt class="py-line">        <tt class="py-docstring">"""</tt> </tt>
<a name="L24"></a><tt class="py-lineno">24</tt>  <tt class="py-line"><tt class="py-docstring">        Sets the sequence: 4 or 8 steps</tt> </tt>
<a name="L25"></a><tt class="py-lineno">25</tt>  <tt class="py-line"><tt class="py-docstring">        @param stepSequence: The step sequence</tt> </tt>
<a name="L26"></a><tt class="py-lineno">26</tt>  <tt class="py-line"><tt class="py-docstring">        @type stepSequence: int8</tt> </tt>
...
<a name="StepperMotorActuator.setDirectionAndVelocity"></a><div id="StepperMotorActuator.setDirectionAndVelocity-def"><a name="L31"></a><tt class="py-lineno">31</tt> <a class="py-toggle" href="#" id="StepperMotorActuator.setDirectionAndVelocity-toggle" onclick="return toggle('StepperMotorActuator.setDirectionAndVelocity');">-</a><tt class="py-line">    <tt class="py-keyword">def</tt> <a class="py-def-name" href="libsensorPy.abstractclass.stepperMotorActuator.StepperMotorActuator-class.php#setDirectionAndVelocity">setDirectionAndVelocity</a><tt class="py-op">(</tt><tt class="py-param">self</tt><tt class="py-op">,</tt><tt class="py-param">stepDir</tt> <tt class="py-op">=</tt> <tt class="py-number">2</tt><tt class="py-op">)</tt><tt class="py-op">:</tt> </tt>
</div><div id="StepperMotorActuator.setDirectionAndVelocity-collapsed" style="display:none;" pad="++" indent="++++++++"></div><div id="StepperMotorActuator.setDirectionAndVelocity-expanded"><a name="L32"></a><tt class="py-lineno">32</tt>  <tt class="py-line">        <tt class="py-docstring">""" Sets the rotation's direction and velocity</tt> </tt>
<a name="L33"></a><tt class="py-lineno">33</tt>  <tt class="py-line"><tt class="py-docstring">        @param stepDir: 1 = clockwise, 2 = fast-clockwise, -1 = anti-clockwise,-2 = fast-anti-clockwise  </tt> </tt>
<a name="L34"></a><tt class="py-lineno">34</tt>  <tt class="py-line"><tt class="py-docstring">        @type stepDir: int8</tt> </tt>
<a name="L35"></a><tt class="py-lineno">35</tt>  <tt class="py-line"><tt class="py-docstring">        """</tt> </tt>
<a name="L36"></a><tt class="py-lineno">36</tt>  <tt class="py-line">        <tt class="py-keyword">pass</tt> </tt>
